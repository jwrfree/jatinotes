      ...
      <AnimatePresence>
        {isVisible && (
          <m.span
            ...
            className="absolute z-50 bottom-full mb-2 px-3 py-2 bg-zinc-100 dark:bg-zinc-200 text-zinc-900 text-xs rounded-lg shadow-xl border border-zinc-200 pointer-events-none min-w-[150px] max-w-[250px]"
          >
            {content}
            {/* Arrow */}
            <span 
